									...
									<div class="card bg-primary card-stretch mb-5 mb-xxl-8">
										...
										<div class="card-body">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Title-->
												<div>
													<a href="{{route('admin.puzzle.index')}}" class="fs-4 text-white text-hover-info fw-bolder">Puzzles</a>
												</div>
												<!--end::Title-->
											</div>
											<!--end::Section-->
									...
									<div class="card bg-info card-stretch mb-5 mb-xxl-8">
										...
										<div class="card-body">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Title-->
												<div>
													<a href="{{route('admin.users.index')}}" class="fs-4 text-white text-hover-primary fw-bolder">Users</a>
												</div>
												<!--end::Title-->
											</div>
											<!--end::Section-->
									...
									<div class="card bg-success card-stretch mb-5 mb-xxl-8">
										...
										<div class="card-body">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Title-->
												<div>
													<a href="#" class="fs-4 text-white text-hover-primary fw-bolder">{{now()->format('d M Y')}}</a>
												</div>
												<!--end::Title-->
											</div>
											<!--end::Section-->
