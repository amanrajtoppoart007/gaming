...
@section("content")
    <div class="row">
        <div class="col-md-12">
            <h1>Privacy Policy for Bulkbajaar</h1>
            <p>At www.bulkbajaar.com, accessible from www.bulkbajaar.com, one of our main priorities is the privacy of
                our visitors. This Privacy Policy document contains types of information that is collected and recorded
                by www.bulkbajaar.com and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in www.bulkbajaar.com. This policy is not
            ...
            <h2>Log Files</h2>
            <p>www.bulkbajaar.com follows a standard procedure of using log files. These files log visitors when they
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                www.bulkbajaar.com.</p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on www.bulkbajaar.com, which are sent
            ...
            <p>Note that www.bulkbajaar.com has no access to or control over these cookies that are used by third-party
                advertisers.</p>
            <h2>Third Party Privacy Policies</h2>
            <p>www.bulkbajaar.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <p>www.bulkbajaar.com does not knowingly collect any Personal Identifiable Information from children under
