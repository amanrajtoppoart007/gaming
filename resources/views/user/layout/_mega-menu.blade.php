								...
								<div class="col-lg-6 pe-lg-25">
									...
									<div class="row">
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="?page=index">Start</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=dashboards/extended">Extended</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=dashboards/light">Light</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=dashboards/compact">Compact</a>
												</li>
											</ul>
										</div>
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/calendar">Calendar</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/chat/private">Private Chat</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/chat/group">Group Chat</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/chat/drawer">Drawer Chat</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/inbox">Inbox</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/shop/shop-1">Shop 1</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/shop/shop-2">Shop 2</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=apps/shop/product">Shop Product</a>
												</li>
											</ul>
										</div>
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=general/faq">FAQ</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=general/pricing">Pricing</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=general/invoice">Invoice</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=general/login">Login</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=general/wizard">Wizard</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=general/error">Error</a>
												</li>
											</ul>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=profile/overview">Overview</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=profile/account">Account</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=profile/settings">Settings</a>
												</li>
											</ul>
										</div>
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=documentation/base/utilities">Components</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=documentation/getting-started">Documentation</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=layout-builder">Layout Builder</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="?page=documentation/getting-started/changelog">Changelog
													<span class="badge badge-changelog badge-light-danger bg-hover-danger text-hover-white fw-bold fs-9 px-2 ms-2">v1.0.5</span></a>
												</li>
											</ul>
										</div>
									</div>
