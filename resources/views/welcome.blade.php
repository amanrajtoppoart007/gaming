...
<!--
Author: Keenthemes
Product Name: Start HTML Free  - Bootstrap 5 HTML Multipurpose Admin Dashboard Template
Upgrade to Pro: https://keenthemes.com/products/start-html-pro
...
<html lang="en">
	...
	<body id="kt_body" data-sidebar="on" class="header-fixed header-tablet-and-mobile-fixed sidebar-enabled">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								...
								<!--end::Search-->
								<!--begin::Message-->
								<button class="btn btn-icon btn-sm btn-active-bg-accent ms-1 ms-lg-6" data-bs-toggle="tooltip" title="Available in &lt;span class='badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1'&gt;Pro&lt;/span&gt; version" data-bs-html="true" data-bs-placement="bottom" id="kt_drawer_chat_toggle">
								...
								<div class="ms-1 ms-lg-6">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-300px" data-kt-menu="true">
										...
										<div class="row row-cols-2 g-0">
											<a href="profile/overview.html" class="border-bottom border-end text-center py-10 btn btn-active-color-primary rounded-0">
											...
											<a href="#" class="col border-bottom text-center py-10 btn btn-active-color-primary rounded-0">
											...
											<a href="#" class="col text-center border-end py-10 btn btn-active-color-primary rounded-0">
											...
											<a href="#" class="col text-center py-10 btn btn-active-color-primary rounded-0">
										...
										<div class="card card-stretch mb-5 mb-xxl-8">
											...
											<div class="card-body pb-0">
												...
												<div class="d-flex flex-column h-100">
													...
													<!--end::Action-->
													<!--begin::Image-->
													<div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom card-rounded-bottom h-200px" style="background-image:url('assets/media/illustrations/terms-2.png')"></div>
													<!--end::Image-->
												</div>
												<!--end::Wrapper-->
											</div>
				...
				<div id="kt_sidebar" class="sidebar bg-info" data-kt-drawer="true" data-kt-drawer-name="sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '350px': '300px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_sidebar_toggler">
					...
					<div class="d-flex flex-column sidebar-body">
											...
											<div class="card-body pt-0">
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Sunspots</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">Mark, Rowling, Esther</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Ocean Drive</a>
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Soar, Eco</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">HTML, CSS. jQuery</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														...
														<span class="text-white opacity-25 fs-7 fw-bold my-1">ASP.NET Developer</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
										...
										<div class="card bg-transparent">
											...
											<div class="card-body pt-0">
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">BP Industries</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">Successful Fellas</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Automatica</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">Successful Fellas</span>
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Python Inc.</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">Most Successful</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
												...
												<div class="d-flex flex-wrap align-items-center">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Active Customers</a>
														<span class="text-white opacity-25 fs-7 fw-bold my-1">Best Customers</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
										...
										<div class="card bg-transparent">
											...
											<div class="card-body pt-0">
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Top Authors</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">Successful Fellas</span>
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Popular Authors</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">Most Successful</span>
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">New Users</a>
														<span class="text-white opacity-25 fw-bold fs-7 my-1">HTML, CSS. jQuery</span>
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="d-flex flex-wrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bolder text-hover-primary fs-6">Active Customers</a>
														<span class="text-white opacity-25 fs-7 fw-bold my-1">Awesome Users</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
						...
						<div id="kt_sidebar_footer" class="py-2 px-5 pb-md-6 text-center">
							<a href="#" class="btn btn-color-white bg-white bg-opacity-10 bg-hover-opacity-20 fw-bolder w-100">View Extended Layout</a>
						</div>
						<!--end::Sidebar footer-->
					</div>
					<!--end::Sidebar Content-->
						...
						<div class="modal-body">
							...
							<div class="row py-10 g-5">
								...
								<div class="col-lg-6 pe-lg-25">
									...
									<div class="row">
										<div class="col-sm-4">
											<h3 class="fw-bolder mb-5">Dashboards</h3>
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="index.html">Start</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Extended
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="dashboards/light.html">Light</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Compact
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
											</ul>
										</div>
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Private Chat
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Group Chat
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Drawer Chat
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Inbox
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Shop 1
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Shop 2
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Shop Product
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
											</ul>
										</div>
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="general/faq.html">FAQ</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="general/pricing.html">Pricing</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="general/invoice.html">Invoice</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Login
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Wizard
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Error
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
											</ul>
										</div>
									...
									<div class="row">
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="profile/overview.html">Overview</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Account
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Settings
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
											</ul>
										</div>
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="documentation/base/utilities.html">Components</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="documentation/getting-started.html">Documentation</a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="#" data-kt-page="pro">Layout Builder
													<span class="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">Pro</span></a>
												</li>
												<li class="menu-item">
													<a class="menu-link ps-0 py-2" href="documentation/getting-started/changelog.html">Changelog
													<span class="badge badge-changelog badge-light-danger bg-hover-danger text-hover-white fw-bold fs-9 px-2 ms-2">v1.0.1</span></a>
												</li>
											</ul>
										</div>
									</div>
										...
										<div class="col-sm-4">
											<a href="#" class="card card-stretch mb-5 bg-light-info hoverable shadow-none min-h-250px">
												<div class="card-body d-flex flex-column p-0">
													...
													<div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom card-rounded-bottom" style="background-image:url('assets/media/illustrations/terms-1.png')"></div>
												</div>
											</a>
										</div>
									</div>
		...
		<button id="kt_explore_toggle" class="explore-toggle btn btn-sm explore-btn-toggle shadow-sm position-fixed fw-bolder zindex-2 top-50 px-8 mt-10 end-0 transform-90 fs-5 rounded-top-0" title="Upgrade to Start HTML Pro" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
			...
			<div class="card shadow-none w-100">
				...
				<div class="card-body" id="kt_explore_body">
					...
					<div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_explore_body" data-kt-scroll-dependencies="#kt_explore_header, #kt_explore_footer" data-kt-scroll-offset="5px">
						...
						<!--end::Licenses-->
						<!--begin::Link-->
						<a href="https://keenthemes.com/products/start-html-pro" class="btn btn-lg explore-btn-primary w-100">Upgrade to
						...
						<div class="pt-15 mb-0">
							...
							<div class="d-flex flex-stack mb-5">
								...
								<!--end::Title-->
								<!--begin::Link-->
								<a href="https://keenthemes.com" target="_black" class="fs-6 fw-bold explore-link">All Products</a>
								<!--end::Link-->
							</div>
							<!--end::Heading-->
							<!--begin::Products-->
							<div class="mb-0">
								<!--begin::Product-->
								<a href="https://keenthemes.com/products/start-html-free" class="btn btn-flex explore-btn-outline w-100 flex-stack active px-4 mb-4">
									<!--begin::Info-->
								...
								<!--end::Product-->
								<!--begin::Product-->
								<a href="https://keenthemes.com/products/start-vue-free" class="btn btn-flex explore-btn-outline w-100 flex-stack px-4 mb-4">
									<!--begin::Info-->
									<div class="d-flex align-items-center me-1">
								...
								<!--end::Product-->
								<!--begin::Product-->
								<a href="https://keenthemes.com/products/start-react-free" class="btn btn-flex explore-btn-outline w-100 flex-stack px-4 mb-4">
									<!--begin::Info-->
									<div class="d-flex align-items-center me-1">
								...
								<!--end::Product-->
								<!--begin::Product-->
								<a href="https://keenthemes.com/products/start-html-pro" class="btn btn-flex explore-btn-outline w-100 flex-stack px-4 mb-4">
									<!--begin::Info-->
									<div class="d-flex align-items-center me-1">
										<img src="assets/media/technology-logos/Html5.png" alt="" class="h-30px me-3" />
										<div class="d-flex flex-column align-items-start">
				...
				<div class="card-footer py-5 text-center" id="kt_explore_footer">
					<a href="https://keenthemes.com/products/start-html-free" class="btn btn-lg explore-btn-secondary w-100">Download
